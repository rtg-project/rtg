...
export default {
  ...
  docsRepositoryBase: "https://github.com/rtg-project/rtg/blob/master/pages",
  titleSuffix: " – rtg",
  search: true,
  unstable_stork: true,
  floatTOC: true,
    ...
    return (
      <>
        ...
        <meta
          ...
          content={
            meta.description ||
            "rtg is a React Hooks library for data fetching. rtg first returns the data from cache (stale), then sends the fetch request (revalidate), and finally comes with the up-to-date data again."
          }
        />
        <meta
          name="og:description"
        ...
        <meta
          name="og:title"
          content={
            title ? title + " – rtg" : "rtg: React Hooks for Data Fetching"
          }
        />
        <meta
          name="og:image"
  ...
  footerText: ({ locale }) => {
    switch (locale) {
      ...
      //   return (
      //     <a
      //       href="https://vercel.com/?utm_source=rtg_zh-cn"
      //       target="_blank"
      //       rel="noopener"
      ...
      //   return (
      //     <a
      //       href="https://vercel.com/?utm_source=rtg_es-es"
      //       target="_blank"
      //       rel="noopener"
      //       className="inline-flex items-center no-underline text-current font-semibold"
      //     >
      ...
      //   return (
      //     <a
      //       href="https://vercel.com/?utm_source=rtg_ja"
      //       target="_blank"
      //       rel="noopener"
      //       className="inline-flex items-center no-underline text-current font-semibold"
      //     >
      ...
      default:
        return (
          <a
            href="https://vercel.com/?utm_source=rtg"
            target="_blank"
            rel="noopener"
            className="inline-flex items-center no-underline text-current font-semibold"
          >
